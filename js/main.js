 ...
 * @param {string} currentPageId - معرف القسم/الصفحة الحالي (مثال: 'data-entry', 'schedule-view', 'reports', 'settings', 'professor-schedules', 'index')
 */
export const initializeAppPage = (currentPageId) => {
    ...
    // إعداد عنصر div التنبيه العالمي في utils، موجود في جميع الصفحات التي تحتوي على <main>
...
document.addEventListener('DOMContentLoaded', () => {
    // تحديد معرف الصفحة الحالي من URL أو من جسم الصفحة (Body ID)
    let currentPageId = document.body.id || 'index'; // إذا لم يكن هناك ID، افترض أنها الصفحة الرئيسية
    ...
    import('./dataManager.js').then(module => {
        ...
        // ثم تهيئة الصفحة بناءً على معرفها
